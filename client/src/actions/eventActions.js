...
export const getEvent = (id) => dispatch => {
    ...
    dispatch(getNotification());
    axios
        .get(`/api/events/${id}` , {headers : {Authorization : token}})
        .then(res => 
            dispatch({
                type: GET_EVENT,
                payload: res.data
...
export const createEvent = (eventData, history) => dispatch => {
    ...
    axios
        .post('/api/events', eventData , {headers : {Authorization : token}})
...
export const addComment = (eventID, commentData, history) => dispatch => {
    ...
    axios
        .post(`/api/events/${eventID}/comments`, commentData , {headers : {Authorization : token}})
        .then(res => 
            dispatch({
                type: GET_EVENT,
                payload: res.data
